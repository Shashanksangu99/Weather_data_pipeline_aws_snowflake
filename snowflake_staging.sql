...
CREATE DATABASE WEATHER_API_PROJECT;

-- Switch to the newly created database
USE DATABASE WEATHER_API_PROJECT;
...
create or replace storage integration s3_int
  ...
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'arn:aws:iam::976255372939:role/AWS-S3-to-Snowflake-role'
  storage_allowed_locations = ('s3://weatherapi-de-project-landing-bucket/snowflake/');
...
create or replace stage ext_csv_stage
  URL = 's3://weatherapi-de-project-landing-bucket/snowflake/'
